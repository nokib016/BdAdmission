...
import com.example.asus.bdadmission.OfflineAppPref.OfflineInfo;
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if(!offlineInfo.getLastNotificationId().equalsIgnoreCase("")){
                    ...
                    dbAllNotification.orderByKey().limitToLast(10).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot i:dataSnapshot.getChildren()
                                    ) {
